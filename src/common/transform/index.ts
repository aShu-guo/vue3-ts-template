 ...
 * 即 百度 转 谷歌、高德
 */
export const BD09ToGCJ02 = function BD09ToGCJ02(bd_lng: number, bd_lat: number) {
 ...
 * 即 谷歌、高德 转 百度
 */
export const GCJ02ToBD09 = function GCJ02ToBD09(lng: number, lat: number) {
 ...
 * GCJ-02 转换为 WGS-84
 */
export const GCJ02ToWGS84 = function GCJ02ToWGS84(lng: number, lat: number) {
  if (out_of_china(lng, lat)) {
    return [lng, lat];
  } else {
...
export const out_of_china = function out_of_china(lng: number, lat: number) {
